export default function Hero() {
  return (
    <section className="text-center mt-8 mb-10 rounded-2xl p-10 sm:p-16 bg-white/10 backdrop-blur-xl border border-white/10 shadow-sm">
      ...
      <p className="text-lg sm:text-xl mt-4 text-slate-300"> Aspiring ML Engineer and Bird Photography Enthusiast - BA in Computer Science, Master&apos;s in IT student</p>
      <a
        href="#projects"
